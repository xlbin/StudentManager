...
public class MainActivity extends ListActivity  implements View.OnClickListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cancleButton = (Button) findViewById(R.id.bn_canel);
